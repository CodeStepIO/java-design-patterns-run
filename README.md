...
<b>java-design-patterns-run</b> is the collection of runtime views of java design patterns from [java-design-patterns](https://github.com/iluwatar/java-design-patterns): you can view a java design pattern's runtime code flow of one of its debugging process in HTML pages (one dubugging step per page and each dubugging step is available) at [codestep.io](https://codestep.io/en/index.html#JavaDesignPatterns), here is a screenshot of one of the HTML pages of the [reader-writer-lock](https://github.com/codestepio/java-design-patterns-run/reader-writer-lock/) design pattern:
![codestep.io:JDP@20240509:reader-writer-lock](screenshot.codestep.io.jpg)

The complete code flow of [reader-writer-lock](https://github.com/codestepio/java-design-patterns-run/reader-writer-lock/) starts [here](https://codestep.io/p/JDP@20240509:reader-writer-lock/), just enjoy it:)

# About the website: [codestep.io](https://codestep.io/)
